...
const startGamePanel = document.querySelector(".game-start")
...
let highScore = localStorage.getItem("high-score-snake") || 0;
...
const initGame = () => {
    ...
    if (snakeX === foodX && snakeY === foodY) {
        ...
        localStorage.setItem("high-score-snake", highScore);
        scoreElem.innerHTML = ""
